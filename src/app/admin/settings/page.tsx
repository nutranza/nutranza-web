    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <AdminCard>
            <div className="space-y-4">
              <div>
                ...
                <input type="text" defaultValue="Nutranza Foods" className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-indigo-500 focus:ring-indigo-500 transition-colors shadow-sm" disabled />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Support Email</label>
                <input type="email" defaultValue="support@nutranza.com" className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-indigo-500 focus:ring-indigo-500 transition-colors shadow-sm" disabled />
              </div>
            </div>
          </AdminCard>
        </div>
        ...
        <div className="lg:col-span-1 border-t border-gray-200 pt-8">
          ...
          <p className="text-sm text-gray-500 mt-1">Share this link with users to let them install the Nutranza app.</p>
        </div>
        <div className="lg:col-span-2 border-t border-gray-200 pt-8">
