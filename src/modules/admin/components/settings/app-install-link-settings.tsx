  ...
  const handleShare = async () => {
    ...
    try {
      await navigator.share({
        title: "Install Nutranza App",
        text: "Install the Nutranza app for a faster shopping experience!",
        url: installUrl,
      })
    } catch {
    ...
    <AdminCard title="App Install Link">
      <div className="space-y-4">
        <p className="text-sm text-gray-600">
          Share this link with anyone to let them install the Nutranza app on their device.
        </p>
