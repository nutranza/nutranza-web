      ...
      <div className="w-full flex flex-col gap-y-6" data-testid="phone-login">
        <form className="w-full flex flex-col" action={sendAction}>
          ...
          <SubmitButton
            ...
            isLoading={isSending}
            className="w-full mt-6 rounded-xl border border-gray-900 bg-gray-900 py-4 text-white shadow-sm hover:bg-gray-800 hover:text-white disabled:bg-gray-400 disabled:text-white transition-colors"
          >
            Send OTP
          </SubmitButton>
        </form>
