      ...
      <div className="w-full px-2.5">
        <div className="group relative overflow-hidden rounded-lg">
          ...
          <IconButton
            ...
            variant="mango"
            className="absolute left-3 top-1/2 z-30 size-10 -translate-y-1/2 opacity-100 transition-[opacity,transform,box-shadow] duration-300 ease-out focus-visible:translate-x-0 focus-visible:scale-100 focus-visible:opacity-100 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-brand-mango md:left-4 md:size-12 md:-translate-x-3 md:scale-95 md:opacity-0 md:group-hover:translate-x-0 md:group-hover:scale-100 md:group-hover:opacity-100 md:group-focus-within:translate-x-0 md:group-focus-within:scale-100 md:group-focus-within:opacity-100"
          >
          ...
          <IconButton
            ...
            onClick={showNext}
            variant="mango"
            className="absolute right-3 top-1/2 z-30 size-10 -translate-y-1/2 opacity-100 transition-[opacity,transform,box-shadow] duration-300 ease-out focus-visible:translate-x-0 focus-visible:scale-100 focus-visible:opacity-100 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-brand-mango md:right-4 md:size-12 md:translate-x-3 md:scale-95 md:opacity-0 md:group-hover:translate-x-0 md:group-hover:scale-100 md:group-hover:opacity-100 md:group-focus-within:translate-x-0 md:group-focus-within:scale-100 md:group-focus-within:opacity-100"
          >
