  ...
  return (
    ...
    >
      ...
      <div className="Container">
        <div className="relative z-10 grid grid-cols-1 gap-y-8 sm:grid-cols-2 sm:gap-x-8 sm:gap-y-8 md:gap-x-12 lg:flex lg:min-h-[520px] lg:items-stretch lg:justify-between lg:gap-0">

          <div className="order-1 flex w-full flex-col items-center justify-between gap-6 text-center sm:order-2 sm:min-h-[240px] sm:items-start sm:text-left lg:order-1 lg:h-[520px] lg:w-2/6 lg:min-h-0">
          ...
          <div className="relative order-2 flex w-full flex-col items-center gap-5 sm:order-1 sm:col-span-2 sm:gap-6 lg:order-2 lg:col-span-1 lg:h-[520px] lg:w-1/4 lg:gap-15 lg:justify-between">
          ...
          <div className="order-3 flex w-full flex-col items-center justify-between gap-8 overflow-hidden text-center sm:min-h-[240px] sm:items-end sm:text-right lg:h-[520px] lg:w-2/6 lg:min-h-0 lg:gap-0">
